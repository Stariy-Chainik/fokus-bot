...
from .athlete import register_athlete_api
...
__all__ = [
    "register_admin_api", "register_athlete_api", "register_miniapp_api",
    "register_miniapp_static", "register_parent_api", "register_teacher_api",
]
