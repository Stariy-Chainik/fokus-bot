...
(сколько занятий, часов, у кого), календарь месяца с точками по занятиям (цвет — группа/индивидуальное, тап ведёт
к дню) и журнал по дням без сумм и кнопок: деньги живут только в счетах. `POST /pay`
